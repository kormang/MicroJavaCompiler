...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Jun 22 19:34:20 CEST 2015
  */
			...
			for(Deque<AdrDest> facts : condTerms){
				...
				for(AdrDest ad : facts){
					...
					if(ad.dest == AdrDest.BEGIN){
						Code.put2(patchAdr, (beginAddress-patchAdr + 1));
 ...
 Code.load(currentDesignator);  
		...
		Obj d = (Obj)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
			...
			if(d.getKind() == Obj.Meth){
				System.err.println("currentThis = " + currentThis.getName());
			...
			System.err.println("thisForMethCall = " + thisForMethCall.getName());
		...
		Struct tt = (Struct)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
